        ...
        {data && (
          <div style={{ padding: 16 }}>
            <Tabs defaultValue="overview" data-testid="v2-drawer-tabs">
              <TabsList
                style={{ background: "var(--v2-bg-panel)", border: "1px solid var(--v2-border-subtle)", padding: 2, borderRadius: 2, gap: 2, display: "flex", width: "100%", justifyContent: "flex-start", overflowX: "auto" }}
              >
                <TabsTrigger value="overview" data-testid="v2-tab-overview">Overview</TabsTrigger>
                <TabsTrigger value="reasoning" data-testid="v2-tab-reasoning">Reasoning</TabsTrigger>
                <TabsTrigger value="verification" data-testid="v2-tab-verification">Verification</TabsTrigger>
                <TabsTrigger value="quote" data-testid="v2-tab-quote">Quote</TabsTrigger>
                <TabsTrigger value="sizing" data-testid="v2-tab-sizing">Sizing</TabsTrigger>
                <TabsTrigger value="evidence" data-testid="v2-tab-evidence">Evidence</TabsTrigger>
              </TabsList>
