...
# ── sys.path bootstrap ──────────────────────────────────────────────────────
# Run correctly whether invoked as ``python -m scripts.vps_multichain_preflight``
# (CWD on sys.path) OR by DIRECT PATH ``python /app/scripts/vps_multichain_preflight.py``
